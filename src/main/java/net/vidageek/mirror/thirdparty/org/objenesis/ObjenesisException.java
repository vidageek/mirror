...
/**
 * Exception thrown by Objenesis. It wraps any instantiation exceptions. Note
 * that this exception is runtime to prevent having to catch it. It will do
 * normal exception wrapping for JDK 1.4 and more and basic message wrapping for
 * JDK 1.3.
 * 
