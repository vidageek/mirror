 ...
 * only supposed to work on Perc JVMs. This instantiator will create classes in
...
public class PercSerializationInstantiator implements ObjectInstantiator {
    ...
    public PercSerializationInstantiator(final Class type) {
        ...
        try {
            ...
            newInstanceMethod = ObjectInputStream.class.getDeclaredMethod("noArgConstruct", new Class[] { Class.class,
                    Object.class, percMethodClass });
