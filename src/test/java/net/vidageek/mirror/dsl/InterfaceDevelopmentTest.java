...
public class InterfaceDevelopmentTest {
	...
	public void testConstructorReflectAllWithMatcherInterface() {
		new Mirror().on(ConstructorFixture.class).reflectAll().constructors()
				.matching(new Matcher<Constructor<ConstructorFixture>>() {
		...
		new Mirror().on(ConstructorFixture.class).reflectAll()
	...
	public void testAnnotationReflectAllWithMatcherInterface() {
		new Mirror().on((AnnotatedElement) FieldFixture.class).reflectAll().annotations()
				.matching(new Matcher<Annotation>() {
		...
		new Mirror().on((AnnotatedElement) FieldFixture.class).reflectAll()
